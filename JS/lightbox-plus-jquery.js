...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function () {
    ...
    let $modalImage = $(".lightbox .lb-image");
    $(".lb-full-screen").on("click", function () {
      if (!isFullscreen) {
        openFullscreen($modalImage[0]); // تحويل العنصر إلى وضع الشاشة الكاملة
        isFullscreen = true;
      } else {
        closeFullscreen(); // الخروج من وضع الشاشة الكاملة
        isFullscreen = false;
      }
    });
